...
//		
//		LCD_SPI2_SetSpeed(SPI_BAUDRATEPRESCALER_4); //设置高速模式
...
u8 LCD_SPI2_ReadWriteByte(u8 TxData)
{
    u8 Rxdata;
...
{   
   ...
   LCD_DC_CLR;  //LCD_DC=0  //设置命令状态
	 LCD_SPI2_ReadWriteByte(regval&0x00FF);
	 LCD_CS_SET;  //LCD_CS=1	 
}
...
void Font_Test(void)
{
	...
	Draw_Font16B(16,160,BLUE,"F: devebox.taobao.com");
...
void Demo_Menu(void)
{
	...
	Draw_Font16B(16,196,RED,"F: devebox.taobao.com");
